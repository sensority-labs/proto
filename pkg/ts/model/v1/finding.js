...
exports.RouteInfo = exports.Finding_MetadataEntry = exports.Finding = exports.Finding_FindingType = exports.Finding_Severity = exports.protobufPackage = void 0;
...
exports.Finding = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.Finding_MetadataEntry.encode({ key: key, value }, writer.uint32(26).fork()).join();
        });
        if (message.type !== 0) {
        ...
        if (message.routeInfo !== undefined) {
            exports.RouteInfo.encode(message.routeInfo, writer.uint32(82).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 10: {
                    ...
                    message.routeInfo = exports.RouteInfo.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    toJSON(message) {
        ...
        if (message.routeInfo !== undefined) {
            obj.routeInfo = exports.RouteInfo.toJSON(message.routeInfo);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.routeInfo = (object.routeInfo !== undefined && object.routeInfo !== null)
            ? exports.RouteInfo.fromPartial(object.routeInfo)
            : undefined;
        return message;
    },
};
...
exports.RouteInfo = {
    ...
    create(base) {
        return exports.RouteInfo.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseRouteInfo();
        message.userName = (_a = object.userName) !== null && _a !== void 0 ? _a : "";
        message.botName = (_b = object.botName) !== null && _b !== void 0 ? _b : "";
        return message;
    },
};
