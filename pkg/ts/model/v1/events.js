...
exports.BlockEvent = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.network !== undefined) {
            exports.BlockEvent_Network.encode(message.network, writer.uint32(26).fork()).ldelim();
        }
        if (message.block !== undefined) {
            exports.BlockEvent_Block.encode(message.block, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.TransactionEvent = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.transaction !== undefined) {
            exports.TransactionEvent_Transaction.encode(message.transaction, writer.uint32(10).fork()).ldelim();
        }
        if (message.network !== undefined) {
            exports.TransactionEvent_Network.encode(message.network, writer.uint32(18).fork()).ldelim();
        }
        Object.entries(message.addresses).forEach(([key, value]) => {
            exports.TransactionEvent_AddressesEntry.encode({ key: key, value }, writer.uint32(26).fork()).ldelim();
        });
        if (message.block !== undefined) {
            exports.TransactionEvent_Block.encode(message.block, writer.uint32(34).fork()).ldelim();
        }
        ...
        Object.entries(message.txAddresses).forEach(([key, value]) => {
            exports.TransactionEvent_TxAddressesEntry.encode({ key: key, value }, writer.uint32(66).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
