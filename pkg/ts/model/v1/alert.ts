...
export interface Finding_IndicatorsEntry {
  key: string;
  value: number;
}
...
export const Finding = {
  encode(message: Finding, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.indicators).forEach(([key, value]) => {
      Finding_IndicatorsEntry.encode({ key: key as any, value }, writer.uint32(90).fork()).ldelim();
    });
    for (const v of message.labels) {
      Label.encode(v!, writer.uint32(98).fork()).ldelim();
    }
    ...
    if (message.source !== undefined) {
      Source.encode(message.source, writer.uint32(122).fork()).ldelim();
    }
    if (message.timestamp !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          const entry11 = Finding_IndicatorsEntry.decode(reader, reader.uint32());
  ...
  fromJSON(object: any): Finding {
    return {
      ...
      indicators: isObject(object.indicators)
        ? Object.entries(object.indicators).reduce<{ [key: string]: number }>((acc, [key, value]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<Finding>, I>>(object: I): Finding {
    ...
    message.indicators = Object.entries(object.indicators ?? {}).reduce<{ [key: string]: number }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
...
function createBaseFinding_IndicatorsEntry(): Finding_IndicatorsEntry {
  return { key: "", value: 0 };
}

export const Finding_IndicatorsEntry = {
  encode(message: Finding_IndicatorsEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Finding_IndicatorsEntry {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Finding_IndicatorsEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
  ...
  toJSON(message: Finding_IndicatorsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create<I extends Exact<DeepPartial<Finding_IndicatorsEntry>, I>>(base?: I): Finding_IndicatorsEntry {
    return Finding_IndicatorsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Finding_IndicatorsEntry>, I>>(object: I): Finding_IndicatorsEntry {
    const message = createBaseFinding_IndicatorsEntry();
    message.key = object.key ?? "";
