...
type TransactionEvent struct {
	...
	IsContractDeployment bool                          `protobuf:"varint,5,opt,name=isContractDeployment,proto3" json:"isContractDeployment,omitempty"`
	ContractAddress      string                        `protobuf:"bytes,6,opt,name=contractAddress,proto3" json:"contractAddress,omitempty"`
	TxAddresses          map[string]bool               `protobuf:"bytes,7,rep,name=txAddresses,proto3" json:"txAddresses,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	Receipt              *TransactionReceipt           `protobuf:"bytes,8,opt,name=receipt,proto3" json:"receipt,omitempty"`
}
...
func (x *TransactionEvent) GetReceipt() *TransactionReceipt {
	if x != nil {
		return x.Receipt
	}
	return nil
...
func (*BigInt) Descriptor() ([]byte, []int) {
	return file_model_v1_events_proto_rawDescGZIP(), []int{2}
}
...
func (*TransactionLog) Descriptor() ([]byte, []int) {
	return file_model_v1_events_proto_rawDescGZIP(), []int{3}
}
...
func (x *TransactionLog) GetBlockNumber() string {
	if x != nil {
		return x.BlockNumber
	}
	return ""
...
func (x *TransactionLog) GetTransactionIndex() string {
	if x != nil {
...
func (x *TransactionLog) GetBlockHash() string {
	if x != nil {
		return x.BlockHash
	}
	return ""
...
func (x *TransactionLog) GetRemoved() bool {
	if x != nil {
		return x.Removed
	}
	return false
...
type TransactionReceipt struct {
	...
	BlobGasUsed       *BigInt           `protobuf:"bytes,1,opt,name=blobGasUsed,proto3,oneof" json:"blobGasUsed,omitempty"`
	BlockHash         string            `protobuf:"bytes,2,opt,name=blockHash,proto3" json:"blockHash,omitempty"`
	BlockNumber       uint64            `protobuf:"varint,3,opt,name=blockNumber,proto3" json:"blockNumber,omitempty"`
	ContractAddress   *string           `protobuf:"bytes,4,opt,name=contractAddress,proto3,oneof" json:"contractAddress,omitempty"`
	CumulativeGasUsed *BigInt           `protobuf:"bytes,5,opt,name=cumulativeGasUsed,proto3" json:"cumulativeGasUsed,omitempty"`
	EffectiveGasPrice *BigInt           `protobuf:"bytes,6,opt,name=effectiveGasPrice,proto3" json:"effectiveGasPrice,omitempty"`
	From              string            `protobuf:"bytes,7,opt,name=from,proto3" json:"from,omitempty"`
	GasUsed           *BigInt           `protobuf:"bytes,8,opt,name=gasUsed,proto3" json:"gasUsed,omitempty"`
	Logs              []*TransactionLog `protobuf:"bytes,9,rep,name=logs,proto3" json:"logs,omitempty"`
	LogsBloom         string            `protobuf:"bytes,10,opt,name=logsBloom,proto3" json:"logsBloom,omitempty"`
	Root              *string           `protobuf:"bytes,11,opt,name=root,proto3,oneof" json:"root,omitempty"`
	Status            string            `protobuf:"bytes,12,opt,name=status,proto3" json:"status,omitempty"`
	To                string            `protobuf:"bytes,13,opt,name=to,proto3" json:"to,omitempty"`
	TransactionHash   string            `protobuf:"bytes,14,opt,name=transactionHash,proto3" json:"transactionHash,omitempty"`
...
func (*TransactionReceipt) Descriptor() ([]byte, []int) {
	return file_model_v1_events_proto_rawDescGZIP(), []int{4}
}

func (x *TransactionReceipt) GetBlobGasUsed() *BigInt {
	if x != nil {
...
func (x *TransactionReceipt) GetCumulativeGasUsed() *BigInt {
	if x != nil {
...
func (x *TransactionReceipt) GetEffectiveGasPrice() *BigInt {
	if x != nil {
...
func (x *TransactionReceipt) GetGasUsed() *BigInt {
	if x != nil {
		return x.GasUsed
	}
	return nil
...
func (x *TransactionReceipt) GetLogs() []*TransactionLog {
	if x != nil {
		return x.Logs
	}
	return nil
...
func (x *TransactionEvent_Block) Reset() {
	*x = TransactionEvent_Block{}
	mi := &file_model_v1_events_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *TransactionEvent_Transaction) Reset() {
	*x = TransactionEvent_Transaction{}
	mi := &file_model_v1_events_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_model_v1_events_proto_rawDesc = []byte{
	...
	0x46, 0x65, 0x65, 0x50, 0x65, 0x72, 0x47, 0x61, 0x73, 0x22, 0x89, 0x09, 0x0a, 0x10, 0x54, 0x72,
	...
	0x52, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x32, 0x0a, 0x14, 0x69, 0x73, 0x43, 0x6f, 0x6e,
	0x74, 0x72, 0x61, 0x63, 0x74, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x14, 0x69, 0x73, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63,
	0x74, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x28, 0x0a, 0x0f, 0x63,
	...
	,
	...
	0x64, 0x1a, 0x95, 0x01, 0x0a, 0x05, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x1c, 0x0a, 0x09, 0x62,
	...
	0x61, 0x6d, 0x70, 0x12, 0x24, 0x0a, 0x0d, 0x62, 0x61, 0x73, 0x65, 0x46, 0x65, 0x65, 0x50, 0x65,
	0x72, 0x47, 0x61, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x62, 0x61, 0x73, 0x65,
	0x46, 0x65, 0x65, 0x50, 0x65, 0x72, 0x47, 0x61, 0x73, 0x1a, 0xcb, 0x02, 0x0a, 0x0b, 0x54, 0x72,
	...
	,
	...
	0x08, 0x52, 0x07, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x22, 0xa0, 0x05, 0x0a, 0x12, 0x54,
	0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x63, 0x65, 0x69, 0x70,
	0x74, 0x12, 0x37, 0x0a, 0x0b, 0x62, 0x6c, 0x6f, 0x62, 0x47, 0x61, 0x73, 0x55, 0x73, 0x65, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x76,
	0x31, 0x2e, 0x42, 0x69, 0x67, 0x49, 0x6e, 0x74, 0x48, 0x00, 0x52, 0x0b, 0x62, 0x6c, 0x6f, 0x62,
	0x47, 0x61, 0x73, 0x55, 0x73, 0x65, 0x64, 0x88, 0x01, 0x01, 0x12, 0x1c, 0x0a, 0x09, 0x62, 0x6c,
	...
	,
	...
	0x6e, 0x64, 0x65, 0x78, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x04, 0x52, 0x10, 0x74, 0x72, 0x61, 0x6e,
	...
	0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x62, 0x6c, 0x6f, 0x62, 0x47, 0x61, 0x73, 0x55, 0x73, 0x65, 0x64,
	0x42, 0x12, 0x0a, 0x10, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x41, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x72, 0x6f, 0x6f, 0x74, 0x42, 0x66, 0x0a,
	0x0c, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x76, 0x31, 0x42, 0x0b, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x08, 0x2e, 0x2f,
...
var file_model_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_model_v1_events_proto_goTypes = []any{
	...
	(*BigInt)(nil),                       // 2: model.v1.BigInt
	(*TransactionLog)(nil),               // 3: model.v1.TransactionLog
	(*TransactionReceipt)(nil),           // 4: model.v1.TransactionReceipt
	(*BlockEvent_Network)(nil),           // 5: model.v1.BlockEvent.Network
	(*BlockEvent_Block)(nil),             // 6: model.v1.BlockEvent.Block
	(*TransactionEvent_Network)(nil),     // 7: model.v1.TransactionEvent.Network
	(*TransactionEvent_Block)(nil),       // 8: model.v1.TransactionEvent.Block
	(*TransactionEvent_Transaction)(nil), // 9: model.v1.TransactionEvent.Transaction
	nil,                                  // 10: model.v1.TransactionEvent.AddressesEntry
	nil,                                  // 11: model.v1.TransactionEvent.TxAddressesEntry
}
var file_model_v1_events_proto_depIdxs = []int32{
	5,  // 0: model.v1.BlockEvent.network:type_name -> model.v1.BlockEvent.Network
	6,  // 1: model.v1.BlockEvent.block:type_name -> model.v1.BlockEvent.Block
	9,  // 2: model.v1.TransactionEvent.transaction:type_name -> model.v1.TransactionEvent.Transaction
	7,  // 3: model.v1.TransactionEvent.network:type_name -> model.v1.TransactionEvent.Network
	10, // 4: model.v1.TransactionEvent.addresses:type_name -> model.v1.TransactionEvent.AddressesEntry
	8,  // 5: model.v1.TransactionEvent.block:type_name -> model.v1.TransactionEvent.Block
	11, // 6: model.v1.TransactionEvent.txAddresses:type_name -> model.v1.TransactionEvent.TxAddressesEntry
	4,  // 7: model.v1.TransactionEvent.receipt:type_name -> model.v1.TransactionReceipt
	2,  // 8: model.v1.TransactionReceipt.blobGasUsed:type_name -> model.v1.BigInt
	2,  // 9: model.v1.TransactionReceipt.cumulativeGasUsed:type_name -> model.v1.BigInt
	2,  // 10: model.v1.TransactionReceipt.effectiveGasPrice:type_name -> model.v1.BigInt
	2,  // 11: model.v1.TransactionReceipt.gasUsed:type_name -> model.v1.BigInt
	3,  // 12: model.v1.TransactionReceipt.logs:type_name -> model.v1.TransactionLog
...
func file_model_v1_events_proto_init() {
	...
	file_model_v1_events_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
